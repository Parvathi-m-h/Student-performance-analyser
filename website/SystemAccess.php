...
<div class="header">
			<div>Request for <span>System Access </span></div>
		</div>     
    ...
    <form method="post">
			...
			<!--<input type="text" placeholder="User Email ID" name="email"><br>-->
           <textarea rows="4" cols="30" placeholde="Reason" name="fb">Reason
                </textarea>
...
if(isset($_POST['login'])){
   ...
   echo "Student ID is required";
    ...
    $sql = "INSERT INTO systemaccess(Roll_no,email, Req_reason)
          VALUES ('$name','$email', '$fb')";
